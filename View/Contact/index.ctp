                                ...
                                <div class="block block-shadow block-margin white opening">
                                    <div class="block-inner">
                                        ...
                                        <div class="opening-hours">
                                            ...
                                            <div class="day clearfix">
                                                <span class="name">Vendredi</span><span class="hours">07:00 AM - 07:00 PM</span>
                                            </div><!-- /.day -->
                                        </div>
                                    </div>
                                </div>
                                ...
                                <?php echo $this->Form->create(''); ?>
                                    ...
                                    <div class="form-inline">
                                        <div class="form-group col-sm-4 col-md-4">
                                            <?php echo $this->Form->input('name',array(' class'=>'form-control','label'=>'Nom Complet')); ?>
                                        </div>
                                        <div class="form-group col-sm-4 col-md-4">
                                            <?php echo $this->Form->input('email',array(' class'=>'form-control','label'=>'Adresse Email','type'=>'email')); ?>
                                        </div>
                                        <div class="form-group col-sm-4 col-md-4">
                                            <?php echo $this->Form->input('subject',array(' class'=>'form-control','label'=>'Subject')); ?>
                                        </div>
                                    </div>

                                    <div class="textarea form-group col-sm-12 col-md-12">
                                        <?php echo $this->Form->input('message',array(' class'=>'form-control','label'=>'Message','type'=>'textarea')); ?>
                                    </div>
