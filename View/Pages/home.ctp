                ...
                <div class="col-md-7 col-sm-7">
                    <div id="slider">
                        <div class="slide active">
                            <a href="detail.html"><img src="../img/slides/toyota.png" alt="#"></a>
                            <div class="color-overlay"></div><!-- /.color-overlay -->
                        </div><!-- /.slide -->

                        <div class="slide">
                            <a href="detail.html"><img src="../img/slides/toyota-1.png" alt="#"></a>
                            <div class="color-overlay"></div><!-- /.color-overlay -->
                        </div><!-- /.slide -->

                        <div class="slide">
                            <a href="detail.html"><img src="../img/slides/toyota-2.png" alt="#"></a>
                            <div class="color-overlay"></div><!-- /.color-overlay -->
                        </div><!-- /.slide -->
                    </div><!-- /#slider -->
                </div>
                                                ...
                                                <div class="inner">
                                                    <div class="picture">
                                                        <div class="image-slider">
                                                            ...
                                                            <a href="detail.html" class="slide"><img src="../img/content/toyota6.jpg" alt="#">
                                                            </a><!-- /.slide -->
