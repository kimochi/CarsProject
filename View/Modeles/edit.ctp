...
<?php echo $this->Form->create('Modele'); ?>
	<fieldset>
		<legend><?php echo __('Edit Modele'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Modele.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Modele.id'))); ?></li>
